...
class HomeViewController: UIViewController {
    ...
    private func configureNavbar(){
        ...
        let TabBarButton = UIBarButtonItem(image: image, style: .done, target: self, action: nil)
        TabBarButton.imageInsets = UIEdgeInsets(top: -7, left: -88, bottom: 0, right: 0) //Непонятно почему
...
extension HomeViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        let offcet = scrollView.contentOffset.y + defaultOffset
